...
export const Form = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-9 flex justify-between pt-3">
      ...
      />
      <button
        className={`absolute right-0 top-0 ${formButtonColor} px-3 py-4 transition-all duration-500 sm:px-5 sm:py-6`}
        style={{
